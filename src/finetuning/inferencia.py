...
# Prompt inicial
initial_prompt = "Xera un poema sobre voar en avión."
...
def adjust_for_ending(logits, history_ids, target_syl, current_syl):
    """
...
def sample_token(history_ids, past_kv, mask, target_syl, current_syl, target_rhyme=None):
    outputs = model(
    ...
    l = adjust_for_ending(l, history_ids, target_syl, current_syl)
        ...
        for verse_idx, (target_syl, letter) in enumerate(stanza, start=1):
            ...
            for attempt in range(1, max_attempts + 1):
                ...
                for step in range(1, max_steps + 1):
                    ...
                    next_token, past_kv = sample_token(history, past_kv, mask, target_syl, current_syl)
                    mask = None
...
if __name__ == '__main__':
    ...
    structure = [[(15, None), (8, None), (15, None), (8, None)],
